 ...
 *  no more need for get.Times.c:\Users\Jonah\dev\read-APSystems-YC600-QS1-DS3\AAA_DECODE.ino
...
//   if (nu - laatsteMeting >= 1000UL * (300 / inverterCount)) 
   if (nu - laatsteMeting >= 1000UL * 60) 
   {
     if(diagNose) ws.textAll( "60 secs passed" ); //
     laatsteMeting += 1000UL * 60 ; // increases each time with (300/inverterCount * miliseconds);
